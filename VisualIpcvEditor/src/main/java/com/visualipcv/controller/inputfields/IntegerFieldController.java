...
public class IntegerFieldController extends Controller<Pane> {
    private TextField valueField;
    private UIProperty valueProperty = new UIProperty();

    public IntegerFieldController() {
        super(Pane.class);
        ...
        valueField.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    ((InputNodeSlot)getContext()).setValue(Integer.parseInt(valueField.getText()));
